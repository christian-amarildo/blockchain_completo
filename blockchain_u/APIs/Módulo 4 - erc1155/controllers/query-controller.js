...
exports.selfCollection = async (req, res, next) => {
  ...
  //get collection
  try {
    let result = await chaincode.evaluateTransaction("SmartContract:SelfCollection");
    result = JSON.parse(result.toString());
...
exports.collection = async (req, res, next) => {
  ...
  //get collection
  try {
    let result = await chaincode.evaluateTransaction("SmartContract:Collection", ownerAccountId);
    result = JSON.parse(result.toString());
